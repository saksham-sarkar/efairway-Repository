package com.efairway.shop.tags;
...
public class ProductImageUrlTag extends RequestContextAwareTag {
	...
	public int doStartTagInternal() throws JspException {
		try {
			...
			System.out.println("Printing image " +"/product-upload/assets/"+this.getImageName());
			//pageContext.getOut().print(imagePath.toString());
			pageContext.getOut().print("/product-upload/assets/"+this.getImageName());
