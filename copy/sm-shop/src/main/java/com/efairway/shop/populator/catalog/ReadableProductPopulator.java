package com.efairway.shop.populator.catalog;
...
import com.efairway.shop.model.catalog.category.ReadableCategory;
...
import com.efairway.shop.model.catalog.product.ReadableImage;
import com.efairway.shop.model.catalog.product.ReadableProduct;
import com.efairway.shop.model.catalog.product.RentalOwner;
import com.efairway.shop.model.catalog.product.attribute.ReadableProductAttribute;
import com.efairway.shop.model.catalog.product.attribute.ReadableProductAttributeValue;
import com.efairway.shop.model.catalog.product.attribute.ReadableProductOption;
import com.efairway.shop.model.catalog.product.attribute.ReadableProductOptionValue;
...
public class ReadableProductPopulator extends
	...
	public ReadableProduct populate(Product source,
		...
		try {
			...
			if(description!=null) {
				com.efairway.shop.model.catalog.product.ProductDescription tragetDescription = new com.efairway.shop.model.catalog.product.ProductDescription();
			...
			if(source.getManufacturer()!=null) {
				...
				com.efairway.shop.model.catalog.manufacturer.ManufacturerDescription d = new com.efairway.shop.model.catalog.manufacturer.ManufacturerDescription();
