package com.efairway.shop.store.controller.order.facade;
...
import com.efairway.shop.model.order.transaction.ReadableTransaction;
...
import com.efairway.shop.model.customer.PersistableCustomer;
import com.efairway.shop.model.customer.ReadableCustomer;
import com.efairway.shop.model.customer.address.Address;
import com.efairway.shop.model.order.OrderEntity;
import com.efairway.shop.model.order.PersistableOrder;
import com.efairway.shop.model.order.PersistableOrderApi;
import com.efairway.shop.model.order.PersistableOrderProduct;
import com.efairway.shop.model.order.ReadableOrder;
import com.efairway.shop.model.order.ReadableOrderList;
import com.efairway.shop.model.order.ReadableOrderProduct;
import com.efairway.shop.model.order.ShopOrder;
import com.efairway.shop.populator.customer.CustomerPopulator;
import com.efairway.shop.populator.customer.PersistableCustomerPopulator;
import com.efairway.shop.populator.order.OrderProductPopulator;
import com.efairway.shop.populator.order.PersistableOrderApiPopulator;
import com.efairway.shop.populator.order.ReadableOrderPopulator;
import com.efairway.shop.populator.order.ReadableOrderProductPopulator;
import com.efairway.shop.populator.order.ShoppingCartItemPopulator;
import com.efairway.shop.populator.order.transaction.PersistablePaymentPopulator;
import com.efairway.shop.populator.order.transaction.ReadableTransactionPopulator;
import com.efairway.shop.store.controller.customer.facade.CustomerFacade;
import com.efairway.shop.store.controller.shoppingCart.facade.ShoppingCartFacade;
import com.efairway.shop.utils.EmailTemplatesUtils;
import com.efairway.shop.utils.ImageFilePath;
import com.efairway.shop.utils.LabelUtils;
import com.efairway.shop.utils.LocaleUtils;
	...
	public Order processOrder(PersistableOrderApi order, Customer customer, MerchantStore store, Language language, Locale locale)
		...
		try {
			...
			if(order.getAttributes() != null && order.getAttributes().size() > 0) {
				...
				for(com.efairway.shop.model.order.OrderAttribute attribute : order.getAttributes()) {
