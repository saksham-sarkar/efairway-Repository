...
public class ProductPriceController {
	...
	private String displayProductPrice(Product product, Long productPriceId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.efairway.shop.admin.model.catalog.ProductPrice pprice = new com.efairway.shop.admin.model.catalog.ProductPrice();
	...
	public String saveProductPrice(@Valid @ModelAttribute("price") com.efairway.shop.admin.model.catalog.ProductPrice price, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
