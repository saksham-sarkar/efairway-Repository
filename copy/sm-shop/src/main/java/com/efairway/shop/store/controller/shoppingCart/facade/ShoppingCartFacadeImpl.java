 ...
 *
 */
package com.efairway.shop.store.controller.shoppingCart.facade;
...
import com.efairway.shop.model.shoppingcart.CartModificationException;
import com.efairway.shop.model.shoppingcart.PersistableShoppingCartItem;
import com.efairway.shop.model.shoppingcart.ReadableShoppingCart;
import com.efairway.shop.model.shoppingcart.ShoppingCartAttribute;
import com.efairway.shop.model.shoppingcart.ShoppingCartData;
import com.efairway.shop.model.shoppingcart.ShoppingCartItem;
import com.efairway.shop.populator.shoppingCart.ReadableShoppingCartPopulator;
import com.efairway.shop.populator.shoppingCart.ShoppingCartDataPopulator;
    ...
    implements ShoppingCartFacade
{
	...
	private com.salesmanager.core.model.shoppingcart.ShoppingCartItem createCartItem(ShoppingCart cartModel,
		...
		//set attributes
		List<com.efairway.shop.model.catalog.product.attribute.ProductAttribute> attributes = shoppingCartItem.getAttributes();
		if (!CollectionUtils.isEmpty(attributes)) {
			for(com.efairway.shop.model.catalog.product.attribute.ProductAttribute attribute : attributes) {
