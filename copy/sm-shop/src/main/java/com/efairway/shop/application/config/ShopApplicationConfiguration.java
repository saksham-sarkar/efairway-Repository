...
import com.efairway.shop.filter.AdminFilter;
import com.efairway.shop.filter.CorsFilter;
import com.efairway.shop.filter.StoreFilter;
...
@Configuration
@ComponentScan({"com.efairway.shop", "com.salesmanager.core.business"})
...
public class ShopApplicationConfiguration extends WebMvcConfigurerAdapter {
  ...
  public void addResourceHandlers(ResourceHandlerRegistry registry) {
    registry.addResourceHandler(configuration.getProperty(ApplicationConstants.MASKED_PATH)+"**").addResourceLocations(configuration.getProperty(ApplicationConstants.EXTERNAL_IMAGE_FOLDER));
  }
