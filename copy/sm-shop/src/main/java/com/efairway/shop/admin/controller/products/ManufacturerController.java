...
import com.efairway.shop.admin.controller.customers.CustomerController;
...
public class ManufacturerController {
	...
	private String displayManufacturer(Long manufacturerId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.efairway.shop.admin.model.catalog.Manufacturer manufacturer = new com.efairway.shop.admin.model.catalog.Manufacturer();
	...
	public String saveManufacturer(@Valid @ModelAttribute("manufacturer") com.efairway.shop.admin.model.catalog.Manufacturer manufacturer, BindingResult result, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
