package com.efairway.shop.admin.controller.products;
...
import com.efairway.shop.admin.model.web.Menu;
...
public class ProductController {
	...
	private String displayProduct(Long productId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.efairway.shop.admin.model.catalog.Product product = new com.efairway.shop.admin.model.catalog.Product();
	...
	public String saveProduct(@Valid @ModelAttribute("product") com.efairway.shop.admin.model.catalog.Product product, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {

		LOGGER.error("============================================= Saksham Product ========================================================================");
		LOGGER.error(product.toString());
		//LOGGER.error("Product............\n"+new Gson().toJson(product));
		ObjectMapper Obj = new ObjectMapper();
//		String jsonStr = Obj.writeValueAsString(product);
//		LOGGER.error("Product json String = "+jsonStr);
		LOGGER.error("" + product.getDateAvailable());
		LOGGER.error("" + product.getProductPrice());
		LOGGER.error("" + product.getProduct().getSku());
		LOGGER.error("" + product.getAvailability().toString());
//		LOGGER.error("" + product.getDescription().getTitle());
		LOGGER.error("" + product.getPrice().toString());
		LOGGER.error("" + product.getProductImage().toString());
		...
		String newProductStr = Obj.writeValueAsString(product);
		LOGGER.error("new product json String = "+newProductStr);*/
		LOGGER.error("Saksham New product..........................................");
		//LOGGER.error("New Product....................\n"+new Gson().toJson(newProduct));
