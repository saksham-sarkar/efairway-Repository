package com.efairway.shop.admin.controller.orders;

import com.efairway.shop.admin.controller.ControllerConstants;
...
private static final Logger LOGGER = LoggerFactory.getLogger(OrderControler.class);
	...
	private String displayOrder(Long orderId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.efairway.shop.admin.model.orders.Order order = new com.efairway.shop.admin.model.orders.Order();
	...
	public String saveOrder(@Valid @ModelAttribute("order") com.efairway.shop.admin.model.orders.Order entityOrder, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
