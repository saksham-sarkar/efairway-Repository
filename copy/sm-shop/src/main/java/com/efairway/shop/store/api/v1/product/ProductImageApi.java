...
import com.efairway.shop.populator.catalog.PersistableProductImagePopulator;
...
public class ProductImageApi {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @RequestMapping(
          value = {"/products/uploadImage"},
          method = RequestMethod.POST)
  @ApiImplicitParams({
          @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
          @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  public @ResponseBody PersistableImage uploadImage(
  ...
  persistableImage.setContentType(file.getContentType());
  persistableImage.setName(fileName);
  persistableImage.setImageUrl(fileDownloadUri);
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @RequestMapping(
          value = {"/products/uploadMultipleImages"},
          method = RequestMethod.POST)
  @ApiImplicitParams({
          @ApiImplicitParam(name = "store", dataType = "String", defaultValue = "DEFAULT"),
          @ApiImplicitParam(name = "lang", dataType = "String", defaultValue = "en")
  })
  public @ResponseBody List<PersistableImage> uploadImages(
