package com.efairway.shop.populator.order;
...
public class ReadableOrderPopulator extends
	...
	public ReadableOrder populate(Order source, ReadableOrder target,
		...
		com.efairway.shop.model.order.total.OrderTotal taxTotal = null;
		com.efairway.shop.model.order.total.OrderTotal shippingTotal = null;
		...
		if(source.getOrderAttributes()!=null && source.getOrderAttributes().size()>0) {
			for(OrderAttribute attr : source.getOrderAttributes()) {
				com.efairway.shop.model.order.OrderAttribute a = new com.efairway.shop.model.order.OrderAttribute();
		...
		List<com.efairway.shop.model.order.total.OrderTotal> totals = new ArrayList<com.efairway.shop.model.order.total.OrderTotal>();
		for(OrderTotal t : source.getOrderTotal()) {
			...
			if(t.getOrderTotalType().name().equals(OrderTotalType.TOTAL.name())) {
				com.efairway.shop.model.order.total.OrderTotal totalTotal = createTotal(t);
				...
				com.efairway.shop.model.order.total.OrderTotal subTotal = createTotal(t);
				totals.add(subTotal);
				
			}
			else {
				com.efairway.shop.model.order.total.OrderTotal otherTotal = createTotal(t);
	...
	private com.efairway.shop.model.order.total.OrderTotal createTotal(OrderTotal t) {
		com.efairway.shop.model.order.total.OrderTotal totalTotal = new com.efairway.shop.model.order.total.OrderTotal();
