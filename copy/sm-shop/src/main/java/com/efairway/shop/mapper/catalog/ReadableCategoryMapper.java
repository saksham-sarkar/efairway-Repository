package com.efairway.shop.mapper.catalog;
...
public class ReadableCategoryMapper implements Mapper<Category, ReadableCategory> {
  ...
  public ReadableCategory convert(Category source, MerchantStore store, Language language) {
    ...
    Optional<com.efairway.shop.model.catalog.category.CategoryDescription> categoryDescription =
        getCategoryDescription(source, language, target);
    categoryDescription.ifPresent(target::setDescription);

    Optional<com.efairway.shop.model.catalog.category.Category> parentCategory =
  ...
  private Optional<com.efairway.shop.model.catalog.category.CategoryDescription>
  ...
  private com.efairway.shop.model.catalog.category.CategoryDescription convertDescription(
      CategoryDescription description, Category source) {
    final com.efairway.shop.model.catalog.category.CategoryDescription desc =
        new com.efairway.shop.model.catalog.category.CategoryDescription();
  ...
  private Optional<com.efairway.shop.model.catalog.category.Category> createParentCategory(
      Category source) {
    return Optional.ofNullable(source.getParent())
        .map(
            parentValue -> {
              final com.efairway.shop.model.catalog.category.Category parent =
                  new com.efairway.shop.model.catalog.category.Category();
