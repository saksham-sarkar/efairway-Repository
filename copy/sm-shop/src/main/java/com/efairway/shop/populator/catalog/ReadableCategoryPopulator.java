...
public class ReadableCategoryPopulator extends
    ...
    public ReadableCategory populate(final Category source,
        ...
        if (source.getDescriptions() != null && source.getDescriptions().size() > 0) {
            ...
            if (description != null) {
                final com.efairway.shop.model.catalog.category.CategoryDescription desc = new com.efairway.shop.model.catalog.category.CategoryDescription();
        ...
        if (source.getParent() != null) {
            final com.efairway.shop.model.catalog.category.Category parent = new com.efairway.shop.model.catalog.category.Category();
